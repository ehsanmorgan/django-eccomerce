...
def seed_brand(n):
    fake=Faker()
    images=['apple.png','Download.jpeg','images_1.jpeg','images_2.jpeg','images_3.jpeg','images_4.jpeg','images_5.jpeg','images_6.jpeg','images_7.jpeg','images_11.jpeg','images.jpeg','samsung.png']
...
def seed_product(n):
    ...
    for _ in range(n):
        ...
        name=fake.name()
        brand=Brand.objects.get(id=random.randint(4,20))
